...
// Test XX: First example from README.txt with cancel and re-add
TEST_F(OrderCacheTest, XX_UnitTest_getMatchingSizeForSecurityTest_Example1)
{
    OrderCache cache;
    ...
    cache.cancelOrder("OrdId8");

    matchingSize = cache.getMatchingSizeForSecurity("SecId2");
    ASSERT_EQ(matchingSize, 2600);
