...
- Use the provided unit tests in `OrderCacheTests.cpp`.
- Refer to `TESTING.txt` for test execution details.

### Submission

- Submit your source code files via email or as a .zip file.
- If your implementation use more files than OrderCache.h and OrderCache.cpp
  ...
  your code to run the OrderCacheTests.

### Additional Information

- Use up to C++17 standards.
- Ensure the code is platform-agnostic.
- Single-threaded support is mandatory. Multithreading is optional but highly
  recommended.
